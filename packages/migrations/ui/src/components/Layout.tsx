...
import { Database, LayoutDashboard, History, Menu, X } from 'lucide-react';

const navItems = [
  { label: 'Dashboard', path: '/', icon: LayoutDashboard },
  { label: 'Migrations', path: '/migrations', icon: Database },
  ...
  const sidebar = (
    <nav className="flex h-full flex-col bg-zinc-900">
      ...
      <div className="flex h-14 items-center gap-2.5 border-b border-zinc-800 px-5">
        ...
        <span className="text-sm font-semibold tracking-tight text-zinc-100">Migrations</span>
      </div>
    ...
    <div className="min-h-screen">
      ...
      <div className="fixed top-0 right-0 left-0 z-40 flex h-14 items-center border-b border-zinc-800 bg-zinc-950/80 px-4 backdrop-blur md:hidden">
        ...
        <div className="ml-3 flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-zinc-100">Migrations</span>
        </div>
      </div>
